  ...
  nginxConf = pkgs.writeText "nginx.conf" ''
    ...
    http {
      ...
      server {
        ...
        location ~ ^/(api/)?(agenda|agenda-files|get-all-todos|complete|update|todo-states|capture-templates|capture|custom-views|custom-view|debug-config|filter-options|restart)$ {
